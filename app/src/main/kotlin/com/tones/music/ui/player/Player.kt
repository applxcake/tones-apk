...
import com.tones.music.constants.QueuePeekHeight
...
import com.tones.music.extensions.toggleRepeatMode
import com.tones.music.models.MediaMetadata
import com.tones.music.ui.component.BottomSheet
import com.tones.music.ui.component.BottomSheetState
...
import com.tones.music.ui.component.ResizableIconButton
import com.tones.music.ui.component.rememberBottomSheetState
import com.tones.music.ui.menu.PlayerMenu
import com.tones.music.ui.screens.settings.DarkMode
import com.tones.music.ui.theme.extractGradientColors
...
fun BottomSheetPlayer(
    ...
    LaunchedEffect(mediaMetadata, playerBackground, useBlackBackground) {
        ...
        if (useBlackBackground && playerBackground != PlayerBackgroundStyle.GRADIENT) {
            ...
            withContext(Dispatchers.IO) {
                try {
                    ...
                    // Fallback to default colors if image processing fails
                    gradientColors = if (useBlackBackground) listOf(Color.Black, Color.Black) else emptyList()
                }
            }
        } else {
