...
import com.tones.music.db.entities.PlaylistSongMapPreview
...
import com.tones.music.db.entities.SortedSongAlbumMap
import com.tones.music.db.entities.SortedSongArtistMap
...
class Migration18To19 : AutoMigrationSpec {
    override fun onPostMigrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("UPDATE song SET isTrash = 0 WHERE isTrash IS NULL")
    }
}
