package com.tones.music.lyrics

import android.text.format.DateUtils
import com.atilika.kuromoji.ipadic.Tokenizer
import com.tones.music.ui.component.ANIMATE_SCROLL_DURATION
...
object LyricsUtils {
    ...
    fun findCurrentLineIndex(
        ...
        // Use binary search for better performance with large lyrics files
        var left = 0
        ...
        while (left <= right) {
            ...
            val lineTime = lines[mid].time
            
            if (lineTime <= position + ANIMATE_SCROLL_DURATION) {
                result = mid
                left = mid + 1
            } else {
                right = mid - 1
