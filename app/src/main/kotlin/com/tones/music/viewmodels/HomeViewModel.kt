...
import com.tones.innertube.models.filterExplicit
...
import com.tones.music.constants.QuickPicks
import com.tones.music.constants.QuickPicksKey
...
import com.tones.music.constants.AccountImageUrlKey
...
import com.tones.music.db.entities.*
import com.tones.music.extensions.toEnum
import com.tones.music.models.SimilarRecommendation
...
class HomeViewModel @Inject constructor(
    ...
    private suspend fun load() {
        ...
        if (YouTube.cookie != null) {
            YouTube.accountInfo().onSuccess { info ->
                ...
                // Persist the account image URL
                info.thumbnailUrl?.let { url ->
                    context.dataStore.edit { preferences ->
                        preferences[AccountImageUrlKey] = url
                    }
                }
            }.onFailure {
                reportException(it)
    ...
    init {
        viewModelScope.launch(Dispatchers.IO) {
            // Load persisted account image URL first
            val persistedImageUrl = context.dataStore.get(AccountImageUrlKey)
            if (persistedImageUrl != null) {
                accountImageUrl.value = persistedImageUrl
            }
